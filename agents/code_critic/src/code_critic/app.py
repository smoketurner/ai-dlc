...
from code_critic.tools import critique_s3_key, write_critique
...
def upload_critique(critique: Critique, *, run_id: str, revision_number: int) -> None:
...
def post_pr_comment(*, payload: CodeCriticInput, critique: Critique) -> None:
    """Best-effort summary comment on the impl PR. Never raises — advisory only."""
