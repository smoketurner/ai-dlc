...
def write_report(*, run_id: str, task_id: str, content: str) -> str:
    """Upload the rendered test report Markdown for a task PR.
    ...
    key = report_s3_key(run_id=run_id, task_id=task_id)
...
def report_s3_key(*, run_id: str, task_id: str) -> str:
    """S3 key under the artifacts bucket for a task test report."""
    return f"runs/{run_id}/tasks/{task_id}/test_report.md"
