...
#
# IMMUTABLE tags + scan-on-push. Lifecycle expires untagged images after a
# week and keeps the most recent N tagged images per repo. AgentCore Runtime
# is granted Pull on the agent repos via repository policy.
################################################################################
